...
function createBrowserStub(){
  ...
  const defaults={fontSize:'16',editorMeasure:'120',intensity:'15',soundVol:'90',realism:'100',reverb:'85',jam:'20',warnTh:'80',badTh:'100',warmupSec:'10',hourglassOpacity:'20',autoReset:'180',hourglassDuration:'600',mode:'write'};
  ...
  const sandbox={
    console,document,Path2D:Path2DStub,Intl,performance:{now:()=>now},
